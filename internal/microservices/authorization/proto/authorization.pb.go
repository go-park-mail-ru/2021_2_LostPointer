...
var file_authorization_proto_rawDesc = []byte{
	...
	0x32, 0xf6, 0x02, 0x0a, 0x0d, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x7a, 0x61, 0x74, 0x69,
	...
	,
...
var file_authorization_proto_depIdxs = []int32{
	...
	0, // 2: session.Authorization.DeleteSession:input_type -> session.Cookie
	0, // 3: session.Authorization.Logout:input_type -> session.Cookie
	4, // 4: session.Authorization.GetAvatar:input_type -> session.UserID
	2, // 5: session.Authorization.Login:input_type -> session.AuthData
	3, // 6: session.Authorization.Register:input_type -> session.RegisterData
	6, // 7: session.Authorization.CreateSession:output_type -> session.Empty
	4, // 8: session.Authorization.GetUserByCookie:output_type -> session.UserID
	6, // 9: session.Authorization.DeleteSession:output_type -> session.Empty
	6, // 10: session.Authorization.Logout:output_type -> session.Empty
	5, // 11: session.Authorization.GetAvatar:output_type -> session.Avatar
	0, // 12: session.Authorization.Login:output_type -> session.Cookie
	0, // 13: session.Authorization.Register:output_type -> session.Cookie
...
func (c *authorizationClient) DeleteSession(ctx context.Context, in *Cookie, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/session.Authorization/DeleteSession", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authorizationClient) Logout(ctx context.Context, in *Cookie, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/session.Authorization/Logout", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Authorization_DeleteSession_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/session.Authorization/DeleteSession",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Authorization_Logout_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/session.Authorization/Logout",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
