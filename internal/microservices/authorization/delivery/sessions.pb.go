...
var file_sessions_proto_rawDesc = []byte{
	...
	0x52, 0x08, 0x4e, 0x69, 0x63, 0x6b, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x07, 0x0a, 0x05, 0x45, 0x6d,
	0x70, 0x74, 0x79, 0x32, 0xee, 0x01, 0x0a, 0x0e, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x43,
	0x68, 0x65, 0x63, 0x6b, 0x65, 0x72, 0x12, 0x3b, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65,
	0x72, 0x42, 0x79, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x14, 0x2e, 0x73, 0x65, 0x73,
	...
	0x44, 0x22, 0x00, 0x12, 0x37, 0x0a, 0x0d, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x53, 0x65, 0x73,
	...
	,
}
...
var file_sessions_proto_goTypes = []interface{}{
	...
	(*Empty)(nil),       // 4: session.Empty
}
var file_sessions_proto_depIdxs = []int32{
	0, // 0: session.SessionChecker.GetUserBySession:input_type -> session.SessionData
	...
	2, // 4: session.SessionChecker.GetUserBySession:output_type -> session.UserID
	4, // 5: session.SessionChecker.DeleteSession:output_type -> session.Empty
...
func (c *sessionCheckerClient) GetUserBySession(ctx context.Context, in *SessionData, opts ...grpc.CallOption) (*UserID, error) {
	out := new(UserID)
	err := c.cc.Invoke(ctx, "/session.SessionChecker/GetUserBySession", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sessionCheckerClient) DeleteSession(ctx context.Context, in *SessionData, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
type SessionCheckerServer interface {
	GetUserBySession(context.Context, *SessionData) (*UserID, error)
	DeleteSession(context.Context, *SessionData) (*Empty, error)
...
func (*UnimplementedSessionCheckerServer) GetUserBySession(context.Context, *SessionData) (*UserID, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetUserBySession not implemented")
}
func (*UnimplementedSessionCheckerServer) DeleteSession(context.Context, *SessionData) (*Empty, error) {
...
func _SessionChecker_GetUserBySession_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SessionData)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SessionCheckerServer).GetUserBySession(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/session.SessionChecker/GetUserBySession",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SessionCheckerServer).GetUserBySession(ctx, req.(*SessionData))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _SessionChecker_GetUserBySession_Handler,
		},
		{
